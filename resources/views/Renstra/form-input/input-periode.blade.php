    ...
    <div class="d-flex justify-content-center">
        <div style="flex: 1;">
            <div class="p-3" style="background: white">
                ...
                <form method="POST" action="/create/periode">
                    @csrf
                    <div class="mb-3">
                        <label for="input-ket">Keterangan Roadmap</label>
                        <div id="input-ket" class="d-flex" style="gap:1%;">
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="flag_keterangan" id="select-ket-8"
                                    value=8 checked>
                    ...
                    {{-- <div class="mb-3">
                        ...
                        <input type="number" class="form-control @error('tahunAkhir') is-invalid @enderror" id="tahunAkhir"
