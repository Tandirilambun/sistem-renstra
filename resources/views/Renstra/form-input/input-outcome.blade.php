    ...
    <div class="d-flex justify-content-center">
        <div style="flex: 1;">
            <div class="p-3" style="background: white;">
                ...
                <form action="/create/outcome" method="post">
                    @csrf
                    <div class="mb-3">
                        <label for="select-periode-4">Periode</label>
                        <select required id="select-periode-4" class="form-select mb-3" aria-label=".form-select-lg example"
                    ...
                    <div class="d-flex justify-content-center align-items-center" style="gap: 1%;">                        
                        <a href="{{route('step-7')}}" class="btn btnAdd" style="background:#008800; color:white;">Back</a>
