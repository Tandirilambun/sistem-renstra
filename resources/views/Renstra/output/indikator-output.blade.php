<nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="/renstrapage/{{$id}}/output/{{$output -> id_output}}">Output</a></li>
        <li class="breadcrumb-item active" aria-current="page">Indikator Output</li>
    </ol>
</nav>
    ...
    <div class="col py-5 d-flex align-items-center">
        <div class="ps-5">
            <div class="detail-relation mb-5">
                <p class="mb-2" style="font-size: 13px;font-weight:bold;">Output</p>
                <p style="font-size: 18px">{{ $parent_output->strategi_output }}</p>
            </div>
            <div class="detail-relation">
                <p class="mb-2" style="font-size: 13px; font-weight:bolder;">Indikator</p>
                <p style="font-size: 18px">{{ $indikatorOutput->deskripsi_indikator_output }}</p>
            </div>
        </div>
    </div>
    <div class="col d-flex justify-content-center">
        <img src="{{ asset('img/illustration/Company-amico.png') }}" alt="company_gif"
                    ...
                    <div class="progress">
                        <div class="progress_item">
                            ...
                            <div class="progress_bar">
                                <div class="bar" data-value="{{ $avg_capaians_output }}"
                                    data-text="{{ $avg_capaians_output }}"></div>
                            </div>
                        </div>
...
<p class="mb-2" style="font-weight: bold; font-size:17px;">Capaian</p>
@if (count($capaians_output) != 0)
    <div class="row chart">
        ...
        @foreach ($capaians_output as $capaian)
            <div class="col card card-capaian px-0 shadow-sm"
                ...
                <div class="card-body px-0">
                    <div class="me-3" style="float: right;">
                        <div class="d-flex">
                            @cannot('staff')
                            <form action="/capaian-indikator-output/{{ $capaian->id_capaian_output }}" method="post">
                                @method('delete')
                                @csrf
                            ...
                            @can('staff')
                                <button type="button"
                                    ...
                                    data-bs-target="#delete-capaian-output-{{ $capaian->id_capaian_output }}"
                                    style="background-color: red; border-radius:100%;">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="8" height="8"
                                        fill="currentColor" class="bi bi-trash3 m-0" viewBox="0 0 16 16">
                                        <path
                            ...
                            <button type="button"
                                ...
                                data-bs-toggle="modal"
                                data-bs-target="#edit-capaian-output-{{ $capaian->id_capaian_output }}"
                    ...
                    <div class="container container-chart m-0 p-0"
                        ...
                        <div class="circular-progress" id="circular-progress-{{ $capaian->id_capaian_output }}"
                            data-id={{ $capaian->id_capaian_output }}>
                            <div class="value-container" id="value-container-{{ $capaian->id_capaian_output }}"
                                data-id={{ $capaian->id_capaian_output }}> {{ $capaian->capaian_output }}
                            </div>
                        </div>
                    </div>
                    ...
                    <div style="display: flex; justify-content:center; align-items:center;">
                        <button type="button" class="btn btn-hasil px-4 mt-2" data-bs-toggle="popover"
                            ...
                            data-bs-title="Capaian dalam {{ $capaian->tahun_output }}"
                            data-bs-content="
                                            <strong> Capaian : {{ $capaian->capaian_output }}% </strong> <br/>
                                            <strong> Deviasi : {{ 100 - $capaian->capaian_output }}% </strong> <br/>
                                            <br/>
                                            {{ $capaian->keterangan_hasil_output }}"
                            style="background-color: white; border-radius:4rem;
                                                text-align:center;font-size:13px;">
                            Progress {{ $capaian->tahun_output }}
                            <i class="fa-solid fa-circle-info ms-1" style="color:#008800; font-size:13px;"></i></button>
                    </div>
                </div>
            </div>
            <!--Modal Update Capaian -->
            <div class="modal fade" id="edit-capaian-output-{{ $capaian->id_capaian_output }}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                ...
                                <div class="modal-body">
                                    <div class="mb-3">
                                        ...
                                        <textarea disabled class="form-control " id="input-hasil" aria-label="With textarea" style="width: 80%;"
                                            name="input-hasil">{{ $indikatorOutput->deskripsi_indikator_output }}</textarea>
                                        <input hidden type="number" class="form-control" id="desc-indikator"
                                            ...
                                            value="{{ $indikatorOutput->id_indikator_output }}">
                                    </div>
                                    <div class="mb-3">
                                        <label for="tahun-capaian">Tahun</label>
                                        <input required type="number" class="form-control" id="tahun-capaian"
                                            placeholder="Tahun Capaian" name="tahun_capaian" style="width: auto" value={{old('tahun_output', $capaian -> tahun_output)}}>
                                    </div>
                                    <div class="mb-3">
                                        <label for="input-hasil">Hasil</label>
                                        <textarea class="form-control " id="input-hasil" aria-label="With textarea" style="width: 80%;" name="input_hasil">{{old('keterangan_hasil_output', $capaian -> keterangan_hasil_output)}}</textarea>
                                    </div>
                                    <div class="mb-3">
                                        <label for="hasil-capaian">Capaian "%"</label>
                                        <input required type="number" class="form-control" id="hasil-capaian" min="0"
                                            max="100" placeholder="Hasil Capaian" name="hasil_capaian" style="width: 20vh" value={{old('capaian_output',$capaian -> capaian_output)}}>
                                    </div>
                                </div>
                            ...
                            <form action="/capaian-indikator-output/{{$capaian -> id_capaian_output}}" method="POST">
                                ...
                                <div class="modal-body">
                                    <input hidden type="text" class="form-control" id="desc-indikator"
                                        placeholder="Indikator Output" name="desc_indikator"
                                        value="{{ $indikatorOutput->deskripsi_indikator_output }}">
                                    <div class="mb-3">
                                        <p> Indikator : <br> {{ $indikatorOutput->deskripsi_indikator_output }}
                                        </p>
                                        <p> Tahun : <br> {{ $capaian->tahun_output }}</p>
                                        <p> Hasil : <br> {{ $capaian->keterangan_hasil_output }}</p>
                                        <p> Capaian : <br>{{ $capaian->capaian_output }}% </p>
                                    </div>
                                    <div class="mb-3">
                                        <label for="message_capaian_output">Message </label>
                                        <textarea required id="message_capaian_output" class="form-control " aria-label="With textarea" style="width: 80%;"
                                            name="message_capaian_output" placeholder="Masukkan Pesan...."></textarea>
                                    </div>
                                </div>
                                <div class="modal-footer">
            ...
            <div class="modal fade" id="delete-capaian-output-{{ $capaian->id_capaian_output }}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered" style="max-width: 70%">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h1 class="modal-title fs-5" id="exampleModalLabel">Modal title</h1>
                        ...
                        <form action="/capaian-indikator-output/{{$capaian -> id_capaian_output}}" method="POST">
                            ...
                            <div class="modal-body">
                                ...
                                <div class="mb-3">
                                    <label for="message_capaian_output">Message </label>
                                    <textarea required id="message_capaian_output" class="form-control " aria-label="With textarea" style="width: 80%;"
                                        name="message_capaian_output" placeholder="Masukkan Pesan....">Please delete this data</textarea>
                                </div>
                            </div>
                            <div class="modal-footer">
                                <button type="button" class="btn btn-secondary"
...
<div class="modal fade" id="create-capaian" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" style="max-width: 70%">
        <div class="modal-content">
            ...
            <form action="/capaian-indikator-output" method="POST">
                @csrf
                <div class="modal-body">
                    <div class="mb-3">
                        <label for="desc-indikator">Indikator</label>
                    ...
                    <div class="mb-3">
                        ...
                        <input required type="number" class="form-control" id="tahun-capaian"
                            ...
                            min="{{ $output -> periode -> tahun_awal}}" 
                            max="{{ $output -> periode -> tahun_akhir}}"
                            value="{{$output -> periode -> tahun_awal}}">
                    </div>
                    <div class="mb-3">
                        <label for="input-hasil">Hasil</label>
