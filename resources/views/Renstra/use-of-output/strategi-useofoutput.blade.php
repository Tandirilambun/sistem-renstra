<nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page">use Of Output</li>
    </ol>
</nav>
        ...
        <div class="container">
            @foreach ($indikators as $indikator_use_of_output)
                <div class="overview-list my-3 mx-2 border px-3 py-1">
                    <a href="/renstrapage/{{$id}}/use-of-output/{{$useOfOutput -> id_use_of_output}}/indikator-use-of-output/{{ $indikator_use_of_output->id_indikator_use_of_output }}"
