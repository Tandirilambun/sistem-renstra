<nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a
                href="/renstrapage/{{ $id }}/intermediate-objective/{{ $intermediateObjective->id_intermediate }}">Intermediate
                Objective</a></li>
...
@if (count($capaians_intermediate) != 0)
    <div class="row chart">
        ...
        @foreach ($capaians_intermediate as $capaian)
                        ...
                        <div class="d-flex">
                            ...
                            @can('staff')
                                <button type="button"
                                    ...
                                    data-bs-target="#delete-capaian-intermediate-{{ $capaian->id_capaian_intermediate }}"
                                    style="background-color: red; border-radius:100%;">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="8" height="8"
                                        fill="currentColor" class="bi bi-trash3 m-0" viewBox="0 0 16 16">
                                        <path
            ...
            <div class="modal fade" id="edit-capaian-intermediate-{{ $capaian->id_capaian_intermediate }}"
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input required type="number" class="form-control" id="tahun-capaian"
                                            ...
                                            value={{ old('tahun_intermediate', $capaian->tahun_intermediate) }}>
                                    </div>
                                    <div class="mb-3">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input required type="number" class="form-control" id="hasil-capaian"
                                            ...
                                            value={{ old('capaian_intermediate', $capaian->capaian_intermediate) }}>
                                    </div>
                                </div>
                            ...
                            <form action="/capaian-indikator-intermediate/{{ $capaian->id_capaian_intermediate }}"
                                ...
                                <div class="modal-body">
                                    <input hidden type="text" class="form-control" id="desc-indikator"
                                        placeholder="Indikator Intermediate" name="desc_indikator"
                                        value="{{ $indikatorIntermediate->deskripsi_indikator_intermediate }}">
                                    <div class="mb-3">
                                        <p> Indikator : <br> {{ $indikatorIntermediate->deskripsi_indikator_intermediate }}
                                        </p>
                                        <p> Tahun : <br> {{ $capaian->tahun_intermediate }}</p>
                                        <p> Hasil : <br> {{ $capaian->keterangan_hasil_intermediate }}</p>
                                        <p> Capaian : <br>{{ $capaian->capaian_intermediate }}% </p>
                                    </div>
                                    <div class="mb-3">
                                        <label for="message_capaian_intermediate">Message </label>
                                        <textarea required id="message_capaian_intermediate" class="form-control " aria-label="With textarea"
                                            style="width: 80%;" name="message_capaian_intermediate" placeholder="Masukkan Pesan...."></textarea>
                                    </div>
                                </div>
                                <div class="modal-footer">
                                    <button type="button" class="btn btn-secondary"
            ...
            <div class="modal fade" id="delete-capaian-intermediate-{{ $capaian->id_capaian_intermediate }}"
                tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered" style="max-width: 70%">
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <form action="/capaian-indikator-intermediate/{{ $capaian->id_capaian_intermediate }}"
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="mb-3">
                                        <label for="message_capaian_intermediate">Message </label>
                                        <textarea required id="message_capaian_intermediate" class="form-control " aria-label="With textarea"
                                            style="width: 80%;" name="message_capaian_intermediate" placeholder="Masukkan Pesan....">Please Delete this data</textarea>
                                    </div>
                                </div>
                                <div class="modal-footer">
                                    <button type="button" class="btn btn-secondary"
            ...
            <form action="/capaian-indikator-intermediate" method="POST">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <input required type="number" class="form-control" id="tahun-capaian"
                            placeholder="Tahun Capaian" name="tahun_capaian" style="width: auto"
                            min="{{ $intermediateObjective -> periode -> tahun_awal}}" 
                            max="{{ $intermediateObjective -> periode -> tahun_akhir}}"
                            value="{{ $intermediateObjective->periode->tahun_awal }}">
                    </div>
                    <div class="mb-3">
                        <label for="input-hasil">Hasil</label>
