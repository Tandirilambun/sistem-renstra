<nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a
                href="/renstrapage/{{ $id }}/general-objective/{{ $generalObjective->id_general }}">General
                Objective</a></li>
        <li class="breadcrumb-item active" aria-current="page">Indikator General Objective</li>
    </ol>
</nav>
...
@if (count($capaians_general) != 0)
    <div class="row chart">
                ...
                <div>
                    ...
                    @if (count($capaians_general) >= 5)
                        <button disabled type="button" class="btn"
                            style="background: #007700; color:white; font-weight:bold;">
        ...
        @foreach ($capaians_general as $capaian)
                        ...
                        <div class="d-flex">
                            ...
                            @can('staff')
                                <button type="button"
                                    ...
                                    data-bs-target="#delete-capaian-general-{{ $capaian->id_capaian_general }}"
                                    style="background-color: red; border-radius:100%; color:white;">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="8" height="8"
                                        fill="currentColor" class="bi bi-trash3 m-0" viewBox="0 0 16 16">
                                        <path
                        ...
                        @can('staff')
                            <form action="/capaian-indikator-general/{{ $capaian->id_capaian_general }}" method="POST">
                                ...
                                <div class="modal-body">
                                    ...
                                    placeholder="Indikator General" name="desc_indikator"
                                    value="{{ $indikatorGeneral->deskripsi_indikator_general }}">
                                    <div class="mb-3">
                                        <p> Indikator : <br> {{$indikatorGeneral->deskripsi_indikator_general}}  </p>
                                        <p> Tahun : <br> {{ $capaian->tahun_general}}</p>
                                        <p> Hasil : <br> {{$capaian->keterangan_hasil_general}}</p>
                                        <p> Capaian : <br>{{ $capaian->capaian_general }}% </p>
                                    </div>
                                    <div class="mb-3">
                                        <label for="message_capaian_general">Message </label>
                                        <textarea required id="message_capaian_general" class="form-control " aria-label="With textarea" style="width: 80%;"
                                            name="message_capaian_general" placeholder="Masukkan Pesan...."></textarea>
                                    </div>
                                </div>
                                <div class="modal-footer">
                                    <button type="button" class="btn btn-secondary"
            ...
            <div class="modal fade" id="delete-capaian-general-{{ $capaian->id_capaian_general }}" tabindex="-1"
                aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered" style="max-width: 70%">
                    <div class="modal-content">
                        <div class="modal-header">
                        ...
                        <form action="/capaian-indikator-general/{{ $capaian->id_capaian_general }}" method="post">
                            ...
                            <div class="modal-body">
                                ...
                                <div class="mb-3">
                                    <label for="message_capaian_general">Message </label>
                                    <textarea required id="message_capaian_general" class="form-control " aria-label="With textarea" style="width: 80%;"
                                        name="message_capaian_general" placeholder="Masukkan Pesan....">Please Delete this data?</textarea>
                                </div>
                            </div>
                            <div class="modal-footer">
                                <button type="button" class="btn btn-secondary"
            ...
            <form action="/capaian-indikator-general" method="POST">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <input required type="number" class="form-control" id="tahun-capaian"
                            placeholder="Tahun Capaian" name="tahun_capaian" style="width: auto"
                            min="{{ $generalObjective -> periode -> tahun_awal}}" 
                            max="{{ $generalObjective -> periode -> tahun_akhir}}"
                            value="{{ $generalObjective->periode->tahun_awal }}">
                    </div>
                    <div class="mb-3">
                        <label for="input-hasil">Hasil</label>
                        <textarea required class="form-control " id="input-hasil" aria-label="With textarea" style="width: 80%;"
                            name="input_hasil"></textarea>
                    </div>
                    <div class="mb-3">
                        <label for="hasil-capaian">Capaian "%"</label>
